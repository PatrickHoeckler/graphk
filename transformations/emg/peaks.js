...
export const args = [
  {
    name: 'minX', type: 'number', value: 0, min: 0,
    tooltip: 'Distância mínima entre 2 pontos no eixo x.'
  },
  {
    name: 'minY', type: 'number', value: 0, min: 0,
    tooltip: 'Distância mínima entre 2 pontos no eixo y. Valor padrão: 0'
  },
]